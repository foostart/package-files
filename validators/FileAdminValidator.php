...
class FileAdminValidator extends AbstractValidator
{
    ...
    public function isValidTitle($input) {
        ...
        $min_lenght = config('file_admin.name_min_length');
        $max_lenght = config('file_admin.name_max_length');

        $file_name = @$input['file_name'];

        if ((strlen($file_name) < $min_lenght)  || ((strlen($file_name) > $max_lenght))) {
